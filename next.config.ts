...
const securityHeaders = [
  ...
  // unfortunately required by Next.js's runtime. Tighten later with nonces.
  {
    ...
    value: [
      "default-src 'self'",
      "img-src 'self' data: blob: https://cdn.sanity.io https://axldybsfbwwcwjekojpw.supabase.co https://tailwindcss.com https://pub-51fbbca95280424ab8caeadcd1f90c1d.r2.dev https://*.tile.openstreetmap.org",
      "font-src 'self' data:",
      "style-src 'self' 'unsafe-inline'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com",
      "connect-src 'self' https://api.stripe.com https://api.brevo.com https://*.supabase.co https://*.pusher.com wss://*.pusher.com https://*.livekit.cloud wss://*.livekit.cloud https://nominatim.openstreetmap.org",
