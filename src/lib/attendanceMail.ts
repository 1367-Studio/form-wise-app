...
export async function sendAbsenceEmail(opts: {
  ...
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto;">
      <div style="background:#EFF6FF;border:1px solid rgba(0,62,163,0.2);border-radius:12px;padding:16px;margin-bottom:16px;">
        <p style="margin:0;color:#002E7A;font-size:14px;font-weight:600;">${subjectByStatus[opts.status]}</p>
      </div>
