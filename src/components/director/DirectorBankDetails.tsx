...
import { Landmark, CheckCircle, CalendarCheck } from "lucide-react";

export default function DirectorBankDetails() {
  const t = useTranslations("DirectorBankDetails");
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-gray-900">12 Apr 2026</p>
        </div>
      </div>
