...
import { GraduationCap, UserPlus, FileText, CheckCircle } from "lucide-react";
import PendingStudents from "@/components/PendingStudents";
import PendingPreinscriptionsTable from "@/components/PendingPreinscriptionsTable";

export default function DirectorInscriptions() {
  const t = useTranslations("DirectorInscriptions");
