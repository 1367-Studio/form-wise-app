...
import { UserRound, Users, UserCheck, UserPlus } from "lucide-react";

export default function DirectorFamilies() {
  const t = useTranslations("DirectorFamilies");
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">96</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">89</p>
        </div>
