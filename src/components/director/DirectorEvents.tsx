...
const TYPE_BADGE: Record<EventType, string> = {
  ...
  GENERAL: "bg-gray-100 text-ink/85",
};

const TYPE_BORDER: Record<EventType, string> = {
  MEETING: "border-l-brand",
...
export default function DirectorEvents() {
  const t = useTranslations("DirectorEvents");
    ...
    <div className="space-y-6">
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="ev-title">{t("titleLabel")}</Label>
                <Input
                  id="ev-title"
                  required
                  value={form.title}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  <Label htmlFor="ev-start">{t("startDateLabel")}</Label>
                  <Input
                    id="ev-start"
                    type="datetime-local"
                    required
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="ev-end">{t("endDateLabel")}</Label>
                  <Input
                    id="ev-end"
                    type="datetime-local"
                    required
              ...
              <div className="space-y-1.5">
                <Label htmlFor="ev-location">{t("locationLabel")}</Label>
                <Input
                  id="ev-location"
                  value={form.location}
                  onChange={(e) =>
      ...
      {sorted.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white px-6 py-16 text-center">
          <p className="text-sm text-ink/60">{t("noEvents")}</p>
        </div>
      ) : (
