    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">24 500 &euro;</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">182</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">27</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">94.2%</p>
        </div>
      </div>
