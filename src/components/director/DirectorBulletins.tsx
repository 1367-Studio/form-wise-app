...
import { ScrollText, FileCheck, Clock, Send } from "lucide-react";

export default function DirectorBulletins() {
  const t = useTranslations("DirectorBulletins");
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-gray-900">164</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-gray-900">146</p>
        </div>
      </div>
