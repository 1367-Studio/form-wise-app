...
import { School, CalendarCheck, CalendarPlus, Settings } from "lucide-react";

export default function DirectorSchoolSettings() {
  const t = useTranslations("DirectorSchoolSettings");
