...
import { Coins, DollarSign, Users, Download } from "lucide-react";

export default function DirectorPayroll() {
  const t = useTranslations("DirectorPayroll");
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">42 800 &euro;</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-semibold text-ink">24</p>
        </div>
